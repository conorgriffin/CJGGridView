...
- (void)drawRect:(CGRect)rect {
    ...
    /*
    This is an 8x8 grid.  Core Graphics starts drawing from the bottom-left
    corner so boardOrigin.y is set to 7-times the square's side length.  This
    starts drawing squares beginning with the upper-left square, working right
    and then down through each row with a couple of nested for-loops
    */
